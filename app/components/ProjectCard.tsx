...
const ProjectCard: React.FC<ProjectCardProps> = ({
  ...
  return (
    <div className="flex-1 h-125 p-6 bg-zinc-900/70 rounded-xl border-white/5 border relative overflow-hidden group cursor-pointer">
      ...
      <p className="text-white/50  font-darker text-xl font-semibold leading-5 max-w-[85%]">
        {description}
      </p>
