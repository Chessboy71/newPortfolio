...
const About = () => {
  return (
    <section
      id="about"
      className=" w-full lg:px-[10vw] px-6 flex lg:flex-row flex-col gap-10 py-20 items-start"
    >
      <div className="2xl:text-6xl lg:text-5xl text-5xl font-black lg:w-1/2 lg:leading-16 -tracking-[0.075em]">
        <span className="text-amber-600">Design-driven</span> development
        <br></br> for modern web experiences
      </div>
      <div className="lg:w-1/2 text-amber-50 text-xl 2xl:text-2xl font-darker font-medium pt-4 flex flex-col">
